...
export const Hero = () => {
  return <div>
    ...
    <div className="relative z-20 px-4 flex justify-center -mt-20 md:-mt-24">
      <div className="items-center justify-center text-center max-w-4xl glass-card rounded-3xl p-8 md:p-12 flex flex-col gap-6">
        ...
        delay: 0.6
          ...
          <form className="flex flex-col sm:flex-row gap-3">
            ...
            <Button type="submit" className="h-12 px-8 bg-coral hover:bg-coral-glow text-primary-foreground font-medium glow-coral transition-all">
              Notify Me
